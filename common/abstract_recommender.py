...
class GeneralRecommender(AbstractRecommender):
    ...
    def __init__(self, config, dataloader):
        ...
        if not config['end2end'] and config['is_multimodal_model']:  #True
            ...
            if os.path.isfile(v_feat_file_path):
                ...
                print('the size of v_feat is {}'.format(self.v_feat.size()))   #size:[7050, 4096]
            ...
            if os.path.isfile(t_feat_file_path):
                ...
                print('the size of t_feat is {}'.format(self.t_feat.size()))   #size:[7050, 384]
